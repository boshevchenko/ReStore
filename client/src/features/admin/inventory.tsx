...
import { resetProductsLoaded, setProductParams } from "../catalog/catalogSlice";
...
export default function Inventory() {
    ...
    async function handleDeleteProduct(id: number) {
        ...
        await agent.Admin.deleteProduct(id)
            ...
            .then(() => dispatch(resetProductsLoaded()))
                            ...
                            >
                                ...
                                <TableCell align="right">
                                    ...
                                    <LoadingButton loading={loading && target === product.id}
                                        onClick={() => handleDeleteProduct(product.id)} startIcon={<Delete />} color='error' />
                                </TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
