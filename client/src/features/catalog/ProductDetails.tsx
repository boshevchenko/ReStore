...
export default function ProductDetails() {
    ...
    function handleUpdateCart() {
        ...
        if (!basketItem || quantity > basketItem.quantity) {
            ...
            //     .then(() => dispatch(removeItem({ productId: product.id, quantity: updatedQuantity }))) //removeItem(product.id, updatedQuantity))
            //     .catch(error => console.log(error))
            //     .finally(() => setSubmitting(false))
        ...
        <Grid container spacing={6}>
            ...
            <Grid item xs={6}>
                ...
                <Typography variant="h4"
                    color='secondary'>${(product.price / 100).toFixed(2)}</Typography>
                <TableContainer>
                    <Table>
                        <TableBody>
                            <TableRow>
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={6}>
                        <LoadingButton
                            ...
                            loading={status.includes('pendingAddItem') || status.includes('pendingRemoveItem')} //{submitting}
